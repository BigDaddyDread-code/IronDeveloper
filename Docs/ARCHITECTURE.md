...
| `IronDev.Client` first | Typed HTTP abstraction between WPF and API |
| No second UI stack until boundary is sealed | WPF stays; direct Infrastructure dependency is removed |
