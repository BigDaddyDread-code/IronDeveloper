...
| Work Item | Supported | Shape, Ticket, Build, Review, and Done stages consume a dedicated backend projection for lifecycle, gate, contract, collaboration, action, failed-apply recovery, and evidence truth. | Assignment, follower, and attributed collaboration data remain empty until backend records exist. |
...
| Shared project channels | Supported | Messages and membership are durable; realtime presence and notification completeness are not claimed. |
