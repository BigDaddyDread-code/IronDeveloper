...
| `conscience_review` | Ask ConscienceAgent Lite to review a proposed action and return Allow, Block, or NeedsMoreEvidence | `IronDev.ReplayRunner agent conscience review` |
