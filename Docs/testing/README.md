...
The [Documentation Contract Checks](DOCUMENTATION_CONTRACT_CHECKS.md) define the repository-wide link, identity, status, route, terminology, and canonical-reference gate.
