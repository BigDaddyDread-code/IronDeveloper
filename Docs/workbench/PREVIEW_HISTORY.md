...
Project creation in preview 3 does not create anything in its workspace. The workspace remains reserved for the later, separately confirmed Repository Setup workflow.
