...
The Tauri frontend has a measured refactor inventory covering oversized components, duplicate hooks, API transformations, gate calculations, navigation state, and local fallback truth. Characterization tests now protect the navigation, chat-gate, and build-status seams before splitting begins.
