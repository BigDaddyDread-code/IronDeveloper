...
[TestClass]
public sealed class OperationalDebuggingApiContractTests
{
    [TestMethod]
    public void OperationalDebugging_ApiSurfaces_AreGetOnly()
    {
    ...
    [TestMethod]
    public void OperationalDebugging_ApiSurfaces_HaveNoPostPutPatchDelete()
    {
        foreach (var file in ControllerFiles())
        {
            var text = File.ReadAllText(file);
    ...
    [TestMethod]
    public void OperationalDebugging_ApiSurfaces_ReturnMutationOccurredFalse()
    {
        foreach (var file in ControllerFiles())
        {
            var text = File.ReadAllText(file);
    ...
    [TestMethod]
    public void OperationalDebugging_ApiSurfaces_ReturnNoAuthorityBoundary()
    {
        foreach (var file in ControllerFiles())
        {
            var text = File.ReadAllText(file);
    ...
    [TestMethod] public void OperationalDebugging_ApiSurfaces_DoNotExposeRawPayloadJson() => AssertNoContentLeak("PayloadJson");
    [TestMethod] public void OperationalDebugging_ApiSurfaces_DoNotExposePrivateReasoning() => AssertNoContentLeak("PrivateReasoning");
    [TestMethod] public void OperationalDebugging_ApiSurfaces_DoNotExposeRawPrompt() => AssertNoContentLeak("RawPrompt");
    [TestMethod] public void OperationalDebugging_ApiSurfaces_DoNotExposeRawCompletion() => AssertNoContentLeak("RawCompletion");
    [TestMethod] public void OperationalDebugging_ApiSurfaces_DoNotExposeRawToolOutput() => AssertNoContentLeak("RawToolOutput");
    [TestMethod] public void OperationalDebugging_ApiSurfaces_DoNotExposeSourceContent() => AssertNoContentLeak("SourceContent");
    [TestMethod] public void OperationalDebugging_ApiSurfaces_DoNotExposePatchPayload() => AssertNoContentLeak("PatchPayload");
    [TestMethod] public void OperationalDebugging_ApiSurfaces_DoNotExposeSecrets() => AssertNoContentLeak("Secret");

    [TestMethod]
    public void OperationalDebugging_ApiRoutes_DoNotContainControlFragments()
    {
        foreach (var route in ControllerRoutes())
        {
            foreach (var fragment in ForbiddenRouteFragments())
                Assert.IsFalse(RouteContainsForbiddenFragment(route, fragment), $"Operational debugging route must not contain control fragment '{fragment}': {route}");
        }
    }

    [TestMethod]
    public void OperationalDebugging_ApiResponses_StateObservationNotAuthority()
    {
    ...
    [TestMethod]
    public void OperationalDebugging_RetentionRules_HaveNoApiSurface()
    {
