...
public sealed class MemoryImprovementProposalTests : IntegrationTestBase
{
    ...
    private Task ApplyAgentMemoryMigrationsAsync() =>
        AgentMemorySchemaTestSupport.ApplyCoreAgentMemoryMigrationsAsync(ConnectionString, FindRepositoryRoot());

    private Task DropAgentMemorySchemaAsync() =>
        AgentMemorySchemaTestSupport.DropAgentMemorySchemaInDependencyOrderAsync(ConnectionString);
