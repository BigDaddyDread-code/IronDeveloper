    ...
    private async Task DropGovernanceSchemaAsync()
    {
        ...
        await connection.ExecuteAsync(
            """
              ...
              IF OBJECT_ID(N'governance.AcceptedApproval', N'U') IS NOT NULL DROP TABLE governance.AcceptedApproval;              IF OBJECT_ID(N'governance.usp_ApprovalDecision_Record', N'P') IS NOT NULL
