...
public sealed class OperationalDebuggingStaticBoundaryTests
{
    ...
    public void OperationalDebugging_PR150_DoesNotAddApiCliSqlOrJobSurface()
    {
        ...
        Assert.IsTrue(changed.Any(file => file.EndsWith("OperationalDebuggingContractTests.cs", StringComparison.Ordinal)), "PR151 should see operational debugging tests in changed files.");
