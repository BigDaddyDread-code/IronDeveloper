...
public sealed partial class SlowQuarantineCategoryContractTests
{
    ...
    public void SlowAndDatabaseTests_AreStillSelectable()
    {
        ...
        StringAssert.Contains(inventory, "`RequiresRealDatabase`: 41 test classes, 421 test methods, 41 files.");
        StringAssert.Contains(inventory, "`LongRunning`: 41 test classes, 422 test methods, 41 files.");
