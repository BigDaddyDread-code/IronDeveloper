...
public sealed partial class SlowQuarantineCategoryContractTests
{
    ...
    public void SlowAndDatabaseTests_AreStillSelectable()
    {
        ...
        StringAssert.Contains(inventory, "`RequiresRealDatabase`: 40 test classes, 420 test methods, 40 files.");
        StringAssert.Contains(inventory, "`LongRunning`: 40 test classes, 420 test methods, 40 files.");
