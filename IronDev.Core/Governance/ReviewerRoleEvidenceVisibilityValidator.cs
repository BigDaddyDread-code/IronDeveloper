...
public static partial class ReviewerRoleEvidenceVisibilityValidator
{
    ...
    [
        "isreviewer = true",
        "reviewergranted = true",
        "canapprove = true",
        "canmerge = true",
        "canmutate = true",
        "cancontinue = true",
        "satisfiesreviewgate = true",
    ...
    public static ReviewerRoleEvidenceVisibilityValidationResult ValidateRequest(
        ReviewerRoleEvidenceVisibilityRequest? request)
    {
        if (request is null)
        {
            return Result(["ReviewerRoleEvidenceVisibilityRequestRequired"], []);
        }
        ...
        AddOptionalSafeTextIssue(request.ReviewerEvidenceRef, "ReviewerEvidenceRef", issues, unsafeRefs);
    ...
    public static bool IsActionIntent(ReviewerRoleEvidenceRequestedIntent intent) =>
        intent is ReviewerRoleEvidenceRequestedIntent.ActionAuthority or
            ReviewerRoleEvidenceRequestedIntent.ApprovalAuthority or
            ReviewerRoleEvidenceRequestedIntent.PolicySatisfaction or
            ReviewerRoleEvidenceRequestedIntent.MutationAuthority or
            ReviewerRoleEvidenceRequestedIntent.WorkflowContinuation or
            ReviewerRoleEvidenceRequestedIntent.VisibilityGrant or
            ReviewerRoleEvidenceRequestedIntent.RedactionBypass or
            ReviewerRoleEvidenceRequestedIntent.PrivateReasoningDisclosure;

    private static ReviewerRoleEvidenceVisibilityValidationResult Result(
