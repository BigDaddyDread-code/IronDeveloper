...
public static partial class RoleCatalogValidator
{
    ...
    [
        ...
        "tenant admin can grant access",
        "tenant admin can manage permissions",
        "tenant admin can access all tenants",
        "tenant admin can bypass tenant isolation",
        "tenant admin can approve policy",
        "tenant admin can continue workflow",
        "tenant admin can operate globally",
        "tenant admin can reveal secrets",
        "tenant admin may operate globally",
        "tenant admin may inspect all tenants",
        "tenant admin may grant itself access",
        "tenant admin may assign roles",
        "tenant admin may manage permissions",
        "tenant admin may approve policy",
        "tenant admin may satisfy policy",
        "tenant admin may continue workflow",
        "tenant admin may bypass redaction",
        "tenant admin may reveal secrets",
        "issystemowner = true",
        ...
        "system owner may operate globally",
        "system owner may inspect all tenants",
        "system owner may grant itself access",
        "system owner may assign roles",
        "system owner may manage permissions",
        "system owner may approve policy",
        "system owner may satisfy policy",
        "system owner may continue workflow",
        "system owner may override governance",
        "system owner may bypass redaction",
        "system owner may reveal secrets",
        "system owner may execute break glass",
        "user assigned",
        "principal",
        "claims principal",
