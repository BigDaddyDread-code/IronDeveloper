...
public enum GovernedActionKind
{
    ...
    SourceApplyRequestCreated,
    PatchArtifactVerified,
    SourceApplyApprovalEvidenceRead,
    SourceApplyGateEvaluated,
    SourceApplyDryRunStarted,
...
public static class AuthorityActionInventory
{
    ...
    [
        ...
        Patch(GovernedActionKind.SourceApplyRequestCreated, "Source-apply request evidence was created for future controlled apply review."),
        Patch(GovernedActionKind.PatchArtifactVerified, "Patch artifact was verified for future controlled source apply review."),
        Patch(GovernedActionKind.SourceApplyApprovalEvidenceRead, "Explicit human approval evidence was read for source-apply readiness evaluation."),
        Patch(GovernedActionKind.SourceApplyGateEvaluated, "Source-apply readiness gate was evaluated for dry-run rehearsal only."),
        Patch(GovernedActionKind.SourceApplyDryRunStarted, "Source-apply dry-run rehearsal was started in a disposable apply workspace."),
