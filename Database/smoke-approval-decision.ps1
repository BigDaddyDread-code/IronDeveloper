...
if ($result.approvalDecisionIsExecutionPermission -or $result.toolExecuted -or $result.sourceApplied -or $result.memoryPromoted -or $result.workflowStarted -or $result.a2aHandoffCreated -or $result.dogfoodReceiptCreated -or $result.externalEffectCreated) {
