...
BEGIN
    ...
    INSERT INTO memory.MemoryProposalEvidenceReference (MemoryProposalEvidenceReferenceId, MemoryProposalId, ProjectId, EvidenceType, EvidenceId, EvidenceLabel, SafeSummary, AllowedUse, GovernanceEventId, WorkflowRunEvidenceReferenceId, WorkflowRunStepId, WorkflowCheckpointId, AgentHandoffId, ThoughtLedgerEntryId)
