---
id: 20260522004251923-local-development
project: IronDev
title: local-development
document_type: Guide
authority: WorkingDraft
source: C:\Users\bob\source\repos\AIDeveloper\Docs\local-development.md
dogfood_run_id: DogfoodDocsSeed-20260522-012
created_utc: 2026-05-22T00:42:51.9359829+00:00
---
...
3.  **Tauri shell dependencies**: Node dependencies are installed from `IronDev.TauriShell`.
...
This restores packages, starts/smoke-tests Weaviate, builds the IronDev solution, and runs a small stabilisation smoke test set.
...
Build the controls:
```powershell
cd IronDev.TauriShell`r`nnpm install`r`nnpm run build
```
...
### Launch
Run the API and Tauri shell from separate terminals:
```powershell
