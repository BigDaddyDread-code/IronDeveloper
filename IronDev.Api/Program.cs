...
builder.Services.AddScoped<ITicketDebateService, TicketDebateService>();
builder.Services.AddScoped<IAlphaConsoleProjectGenerator, AlphaConsoleProjectGenerator>();
builder.Services.AddScoped<IAlphaHelloWorldCodeRunService, AlphaHelloWorldCodeRunService>();
