...
builder.Services.AddControllers(options => options.Filters.Add<RouteBodyScopeBindingFilter>());
...
builder.Services.AddScoped<IronDev.Core.Provisioning.IProjectProvisioningActionService, ProjectProvisioningActionService>();
...
builder.Services.AddScoped<IControlledSourceMutationExecutor, ControlledSourceMutationExecutor>();
builder.Services.AddScoped<IDisposableWorkspaceApplyCopyService, DisposableWorkspaceApplyCopyService>();
builder.Services.AddScoped<ISkeletonApplyMutationBoundaryBarrier, NoOpSkeletonApplyMutationBoundaryBarrier>();
builder.Services.AddScoped<ISkeletonApplySpine, SkeletonApplySpine>();
